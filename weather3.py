...
# Construct the API call URL for One Call API
...
if response.status_code == 200:
    ...
    # Iterate through the hourly forecast data (next 48 hours)
    for forecast in forecast_data['hourly']:
        ...
        temp = forecast['temp']  # Temperature in Fahrenheit
        dewp = forecast['dew_point']  # Dew point in Fahrenheit
        humid = forecast['humidity']  # Humidity
        wind_speed = forecast['wind_speed']  # Wind speed in m/s
